<div class="mx-auto mt-16 max-w-screen-lg">
	<p class="text-center">
		...
		<strong> au moins une semaine à l'avance. </strong>
		En anticipant votre commande, je pourrai mettre tout en œuvre pour créer des créations gourmandes
		exceptionnelles dans les meilleures conditions.
	</p>
	<br />
	<p class="text-center">
		N'hésitez pas à me contacter pour discuter de vos besoins et de vos préférences en matière de
